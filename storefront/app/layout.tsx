...
export const metadata: Metadata = {
  title: {
    default: 'Glow Lift Pro — Microcurrent Facial Lifting Device',
    template: '%s | Glow Lift Pro',
  },
  description: 'Science-backed microcurrent technology for visible facial lifting, toning, and anti-aging results at home. Trusted by thousands of women.',
}
